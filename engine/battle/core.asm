...
UnknownMovesList_3dba3: ; 3dba3 (f:5ba3)
	...
	db WRAP, THRASH, TAIL_WHIP, LEER, BITE, GROWL, SLUDGE_BOMB, SING, PECK, COUNTER
	db STRENGTH, ABSORB, STRING_SHOT, EARTHQUAKE, FLAME_WHEEL, DIG, TOXIC, SCREECH, HARDEN
	db MINIMIZE, WITHDRAW, DEFENSE_CURL, METRONOME, LICK, CLAMP, CONSTRICT, POISON_GAS
	db LEECH_LIFE, BUBBLE, FLASH, GIGA_DRAIN, ACID_ARMOR, FURY_SWIPES, REST, SHARPEN, SLASH, SUBSTITUTE
	db $00
	db $FF ; terminator
