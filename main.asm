...
AddItemToInventory_: ; ce04 (3:4e04)
	...
	push hl
	push hl
	ld d,MY_PC_SIZE ; PC box can hold 50 items
...
; if the destination is the bag
	ld d,BAG_SIZE ; bag can hold 20 items
...
CeladonGymBlocks: INCBIN "maps/celadongym_mod.blk"
...
ViridianGymBlocks: INCBIN "maps/viridiangym_mod.blk"
...
CinnabarGymBlocks: INCBIN "maps/cinnabargym_mod.blk"
