ViridianGymObject: ; 0x74bde (size=105)
	...
	db SPRITE_BLACK_HAIR_BOY_1, $5 + 4, $d + 4, $ff, $d3, TRAINER | $2, COOLTRAINER_M + $C8, $a
	db SPRITE_GYM_HELPER, $f + 4, $10 + 4, $ff, $d0, $3 ; person
	db SPRITE_BALL, $9 + 4, $10 + 4, $ff, $ff, ITEM | $4, REVIVE
