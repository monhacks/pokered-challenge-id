...
JrTrainerFData: ; 39e9d (e:5e9d)
	db 50,SEAKING,GOLDUCK,POLIWHIRL,0 ; misty's gym 1
...
MistyData: ; 3a3bb (e:63bb)
	db $FE
    db 50,GOLDUCK,AMNESIA,ICE_BEAM,SURF,REST
...
ErikaData: ; 3a3c9 (e:63c9)
	db $FE
    db 50,TANGELA,SLEEP_POWDER,STUN_SPORE,GROWTH,MEGA_DRAIN
    db 50,VENUSAUR,RAZOR_LEAF,SLEEP_POWDER,SWORDS_DANCE,BODY_SLAM
    db 50,PARASECT,SPORE,SWORDS_DANCE,BODY_SLAM,MEGA_DRAIN
...
KogaData: ; 3a3d1 (e:63d1)
    ...
    db 50,GOLBAT,SCREECH,CONFUSE_RAY,HYPER_BEAM,HAZE
    db 50,WEEZING,SLUDGE,EXPLOSION,THUNDERBOLT,FIRE_BLAST
    db 50,MUK,SLUDGE,BODY_SLAM,MEGA_DRAIN,EXPLOSION
...
SabrinaData: ; 3a3e5 (e:63e5)
    ...
    db 50,EXEGGUTOR,SLEEP_POWDER,PSYCHIC_M,EXPLOSION,MEGA_DRAIN
    db 50,SLOWBRO,AMNESIA,SURF,THUNDER_WAVE,REST
    db 0
...
Green3Data: ; 3a491 (e:6491)
    rept 3
    db $FE
    db 50,PIDGEOT,DOUBLE_EDGE,HYPER_BEAM,AGILITY,MIRROR_MOVE
    ...
    db 55,MEW,THUNDERBOLT,BLIZZARD,SOFTBOILED,PSYCHIC_M
    db 0
    endr
LoreleiData: ; 3a4bb (e:64bb)
	db $FE
    db 50,JYNX,LOVELY_KISS,BLIZZARD,PSYCHIC_M,COUNTER
    db 50,DEWGONG,SURF,BLIZZARD,BODY_SLAM,REST
    db 50,CLOYSTER,CLAMP,BLIZZARD,HYPER_BEAM,EXPLOSION
    db 50,LAPRAS,ICE_BEAM,REST,BODY_SLAM,CONFUSE_RAY
